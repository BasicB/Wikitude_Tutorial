var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.tracker = new AR.ClientTracker("assets/colors.wtc", {
		...
		*/
		...
		var imgOne = new AR.ImageResource("assets/rhinoText.png");
		...
		*/
		var pageOne = new AR.Trackable2DObject(this.tracker, "blue", {
			drawables: {
				cam: overlayOne
			}
		});
		...
		*/
		var imgTwo = new AR.ImageResource("assets/cat.png");
		...
		*/
		var pageTwo = new AR.Trackable2DObject(this.tracker, "green", {
			drawables: {
				cam: overlayTwo
			}
		});
			...
			/*
        			Similar to the first part, the image resource and the AR.ImageDrawable for the second overlay are created.
        		*/
        		var imgThree = new AR.ImageResource("assets/dino.png");
        		...
        		/*
        			The AR.Trackable2DObject for the second page uses the same tracker but with a different target name and the second overlay.
        		*/
        		var pageThree = new AR.Trackable2DObject(this.tracker, "red", {
        			drawables: {
        				cam: overlayThree
        			}
        		});
